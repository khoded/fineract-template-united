...
ENV FINERACT_HIKARI_JDBC_URL="jdbc:mysql://ucap.mysql.database.azure.com:3306/fineract_tenants"
ENV FINERACT_HIKARI_USERNAME="ucap"
ENV FINERACT_HIKARI_PASSWORD="@Maneater"
...
ENV DRIVERCLASS_NAME="org.drizzle.jdbc.DrizzleDriver"
ENV PROTOCOL="jdbc"
ENV node_id="1"
ENV SUB_PROTOCOL="mysql:thin"
ENV fineract_tenants_driver="org.drizzle.jdbc.DrizzleDriver"
ENV fineract_tenants_url="jdbc:mysql:thin://ucap.mysql.database.azure.com:3306/fineract_tenants"
ENV fineract_tenants_uid="ucap"
ENV fineract_tenants_pwd="@Maneater"
ENV FINERACT_DEFAULT_TENANTDB_HOSTNAME="ucap.mysql.database.azure.com"
ENV FINERACT_DEFAULT_TENANTDB_PORT="3306"
ENV FINERACT_DEFAULT_TENANTDB_UID="upcap"
ENV FINERACT_DEFAULT_TENANTDB_PWD="@Maneater"
ENV FINERACT_DEFAULT_TENANTDB_CONN_PARAMS=
ENV FINERACT_TENANT_URL_PROTOCOL="jdbc"
ENV FINERACT_TENANT_URL_SUB_PROTOCOL="mariadb"
