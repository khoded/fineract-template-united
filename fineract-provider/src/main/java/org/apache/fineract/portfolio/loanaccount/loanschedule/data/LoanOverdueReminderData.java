...
public class LoanOverdueReminderData {
    ...
    public LoanOverdueReminderData(Long loanId, Long clientId, Long groupId, Long loanProductId, Long loanScheduleId, LocalDate dueDate,
