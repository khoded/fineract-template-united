...
public class GuarantorData {
    ...
    private GuarantorData(Integer guarantorTypeId, Integer clientRelationshipTypeId, Long entityId, String firstname, String lastname,
            ...
            Integer rowIndex, Long accountId, String locale, String dateFormat,Boolean pep, String bvn, String email, String middlename,CodeValueData gender) {
    ...
    public static GuarantorData template(final List<EnumOptionData> guarantorTypeOptions,
            final Collection<CodeValueData> allowedClientRelationshipTypes, Collection<PortfolioAccountData> accountLinkingOptions,Collection<CodeValueData> genderOptions) {
    ...
    public static GuarantorData templateOnTop(final GuarantorData guarantorData, final List<EnumOptionData> guarantorTypeOptions,
        ...
        return new GuarantorData(guarantorData.id, guarantorData.loanId, guarantorData.clientRelationshipType, guarantorData.entityId,
                ...
                guarantorTypeOptions, allowedClientRelationshipTypes, accountLinkingOptions,genderOptions,guarantorData.pep,guarantorData.bvn, guarantorData.email,guarantorData.middlename,guarantorData.gender);
    }
    ...
    public static GuarantorData mergeClientData(final ClientData clientData, final GuarantorData guarantorData) {
        return new GuarantorData(guarantorData.id, guarantorData.loanId, guarantorData.clientRelationshipType, guarantorData.entityId,
                ...
                guarantorData.accountLinkingOptions,guarantorData.genderOptions,guarantorData.pep,guarantorData.bvn, guarantorData.email,guarantorData.middlename,guarantorData.gender);
    }
    ...
    public GuarantorData(final Long id, final Long loanId, final CodeValueData clientRelationshipType, final Long entityId,
            ...
            final Collection<CodeValueData> allowedClientRelationshipTypes, final Collection<PortfolioAccountData> accountLinkingOptions,Collection<CodeValueData> genderOptions, Boolean pep,String bvn, String email,
                         String middlename,CodeValueData gender) {
        this.id = id;
        this.loanId = loanId;
