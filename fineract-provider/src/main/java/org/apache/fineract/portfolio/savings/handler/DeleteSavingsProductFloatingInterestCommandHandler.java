...
import org.apache.fineract.portfolio.savings.service.SavingsProductFloatingInterestRateWritePlatformService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

@Service
@CommandType(entity = "SAVINGSPRODUCTFLOATINGINTERESTRATE", action = "DELETE")
public class DeleteSavingsProductFloatingInterestCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return this.savingsProductFloatingInterestRateWritePlatformService.deleteSavingsProductFloatingInterestRate(command.entityId());
    }
}
