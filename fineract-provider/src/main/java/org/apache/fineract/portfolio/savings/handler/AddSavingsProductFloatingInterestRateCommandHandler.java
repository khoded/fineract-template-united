...
@Service
@CommandType(entity = "SAVINGSPRODUCTFLOATINGINTERESTRATE", action = "CREATE")
public class AddSavingsProductFloatingInterestRateCommandHandler implements NewCommandSourceHandler {
